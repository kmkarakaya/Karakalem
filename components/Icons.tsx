...
import { UploadCloud, Download, RefreshCw, Loader2, AlertCircle, X, Key, PenTool } from 'lucide-react';
...
export const ImageIconStyled = ({ className }: { className?: string }) => <PenTool className={className || "w-6 h-6"} />;
